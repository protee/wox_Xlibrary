...
<img src="https://www.protee.org/images/wox_Xlibrary/wox_Xlibrary.png" alt="wox_Xlibrary Logo" width="120" align="right">

<strong style="font-size:1.2em">The Silent Engine</strong><br>
<strong>Mantra:</strong> No reinvention, only rhythm.<br>
<strong>Tagline:</strong> Low-level, high wisdom.
...
Starting with 4D 21, the recommended way to install wox_Xlibrary (and any ogTools component) is through the **Dependencies Manager** using the **GitHub repository**:
